...
public class ShangpintuihuoController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShangpintuihuoEntity shangpintuihuo, 
		...
		if(tableName.equals("nonghu")) {
			shangpintuihuo.setNonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			shangpintuihuo.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShangpintuihuoEntity shangpintuihuo, HttpServletRequest request){
    ...
    public R add(@RequestBody ShangpintuihuoEntity shangpintuihuo, HttpServletRequest request){
    	shangpintuihuo.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(shangpintuihuo);
    	shangpintuihuo.setUserid((Long)request.getSession().getAttribute("userId"));
